...
//   const info = await mail.sendMail({ from: process.env.EMAIL_FROM || '"FitOS" <info@f8os.in>', to, subject, html, text })
 ...
 *
 * Optional:
 *   EMAIL_FROM="FitOS <info@f8os.in>"   ← platform default sender
 *
